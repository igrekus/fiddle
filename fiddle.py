...
_0_to_99 = _0_to_99[1:]
_100_to_199 = ['сто'] + [f'сто {s}' for s in _0_to_99]
_200_to_299 = ['двести'] + [f'двести {s}' for s in _0_to_99]
_300_to_399 = ['триста'] + [f'триста {s}' for s in _0_to_99]
_400_to_499 = ['четыреста'] + [f'четыреста {s}' for s in _0_to_99]
_500_to_599 = ['пятьсот'] + [f'пятьсот {s}' for s in _0_to_99]
_600_to_699 = ['шестьсот'] + [f'шестьсот {s}' for s in _0_to_99]
_700_to_799 = ['семьсот'] + [f'семьсот {s}' for s in _0_to_99]
_800_to_899 = ['восемьсот'] + [f'восемьсот {s}' for s in _0_to_99]
_900_to_999 = ['девятьсот'] + [f'девятьсот {s}' for s in _0_to_99]

...
Фрилансер Василий получил от книжного магазина "Зелёный змий" заказ на доработку системы складского учёта. Суть такова...
    ...
    - по истечении суток, система производит автоматический переучёт срока годности и показателя качества товара для всех позиций на складе
...
Василий, несмотря на то, что фрилансер, калач уже тёрнтый и поэтому прекрасно понимает, что заказчик обычно не технарь и ТЗ пишет через задницу, поэтому поведение системы придётся уточнять через тесты для существубщего кода.

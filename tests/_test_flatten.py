...
from find_missing import find_duplicate, find_missing
# from solutions_old.find_num_reduce import find_missing, find_duplicate
...
def Stest_find_missing_random():
    n = 100
    seq = list(range(1, n + 1))
    random.shuffle(seq)
    expected = seq.pop(random.randint(2, n))
